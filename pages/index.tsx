      ...
      <div className={styles.selfIntroduction}>
        ...
        <div className={styles.introductionText}>
          ...
          <div className={styles.icon}>
            <a href="https://github.com/Inagaki-Tsubasa" className={styles.githubIcon}>
              <FontAwesomeIcon icon={faGithub} />
            </a>
            <a href="https://www.instagram.com/gakkie_ab/" className={styles.instaIcon}>
              <FontAwesomeIcon icon={faInstagram} />
            </a>
            <a href="https://twitter.com/machino_end" className={styles.twitterIcon}>
